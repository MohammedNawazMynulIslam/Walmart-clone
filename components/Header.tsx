...
<input name='input'  className='flex-1 px-4 rounded-l-full outline-none placeholder:text-sm text-black' type="text" placeholder="Search for products"/>
<button type="submit">
...
<div className='flex space-x-5 mt-5 md:mt-0'>
  ...
  <Link href="/" className='hidden text-white font-bold items-center space-x-2 text-sm'>
    <LayoutGrid size={20}/>
    <p>Services</p>
  </Link>
